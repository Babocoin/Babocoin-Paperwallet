...
(function () {
    ...
    function makeAddress(keypair) {
        ...
        var ripemd_extended = [isTestnet ? 0x42 : 0x1A];
    ...
    function makeSegwitAddress(keypair) {
        ...
        var redeemscripthash = [isTestnet ? 0x41 : 0x19];
    ...
    function makeBech32Address(keypair) {
        ...
        var address = isTestnet ? "tbabo1" : "babo1";
        for (var i = 0; i < result.length; ++i)
            address += bech32Chars[result[i]];
        var checksum = bech32CreateChecksum(isTestnet ? "tbabo" : "babo", result);
